...
public class Principal {
    ...
    private final String API_KEY = "&apikey=5b1cbe98";
    ...
    private void buscaSeriesPorCategoria() {
        System.out.println("Qual categoria/gênero deseja buscar as séries? ");
        var nomeGenero = leitura.nextLine();
        Categoria categoria = Categoria.fromPorutgues(nomeGenero);
    ...
    private void buscarSeriesPorTemporada() {
        ...
        System.out.println("Séries com menos de " + numeroTemporadas + " temporadas e avaliação superior a " + avaliacao + " :");
    ...
    private void buscarEpisodiosPorData() {
        ...
        if (serieBusca.isPresent()) {
            ...
            List<Episodio> episodiosAno = repositorio.episodiosDeSeriePorAno(serie, anoLancamento);
